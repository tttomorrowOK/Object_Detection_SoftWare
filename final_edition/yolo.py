...
class YOLO(object):
    ...
    def detect_image(self, image, frame):
        ...
        print(result_info)
        font = ImageFont.truetype(font='simsun.ttc',   #font/FiraMono-Medium.otf',
...
def detect_video(yolo, video_path, output_path=""):
    ...
    while True:
        ...
        image, result_info = yolo.detect_image(image, frame)
        a.set_test(result_info)
